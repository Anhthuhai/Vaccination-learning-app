...
const styles = StyleSheet.create({
  ...
  count: { fontSize: 13, color: colors.textMuted, marginBottom: 12, marginTop: 2 },
  search: {
    borderWidth: 1,
  ...
  cardTitle: { fontSize: 17, fontWeight: '700', color: colors.primaryDark, flex: 1, marginRight: 8 },
  badge: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
  badgeEpi: { backgroundColor: colors.successLight },
  badgeService: { backgroundColor: colors.warningLight },
  badgeText: { fontSize: 11, fontWeight: '700', color: colors.textMuted },
  cardSub: { fontSize: 14, color: colors.textMuted, marginTop: 4 },
  brands: { fontSize: 13, color: colors.textFaint, marginTop: 4 },
  details: { marginTop: 10 },
  detailRow: { fontSize: 14, marginBottom: 4 },
  detailDesc: { fontSize: 14, color: colors.text, marginTop: 6, lineHeight: 20 },
  detailLabel: { fontSize: 14, fontWeight: '700', marginTop: 8 },
  detailBody: { fontSize: 14, color: colors.textMuted, lineHeight: 20 },
  detailNote: { fontSize: 13, color: colors.danger, marginTop: 8, fontStyle: 'italic' },
  expandHint: { fontSize: 13, color: colors.primary, marginTop: 8, fontWeight: '600' },
  ...
  doseBrand: { fontSize: 14, fontWeight: '700', color: colors.primaryDark },
  doseLine: { fontSize: 13, color: colors.text, marginTop: 2 },
  ...
  doseChipRoute: { backgroundColor: colors.successLight },
  doseChipText: { fontSize: 12, fontWeight: '600', color: colors.text },
  doseNote: { fontSize: 12, color: colors.textMuted, marginTop: 4, fontStyle: 'italic' },
  disclaimer: { fontSize: 12, color: colors.textFaint, fontStyle: 'italic', marginTop: 8, marginBottom: 20 },
});
